...
FragTrap::FragTrap() :
Robot(100, 100, 100, 100, 1, 30, 20, 5) {
...
Robot(name, 100, 100, 100, 100, 1, 30, 20, 5) {
	_f[0] = &FragTrap::attackRandom0;
	_f[1] = &FragTrap::attackRandom1;
	_f[2] = &FragTrap::attackRandom2;
	_f[3] = &FragTrap::attackRandom3;
...
{
	*this = copy;
	std::cout << "FragTrap copy constructor called with : " << _name << std::endl;
}
...
void	FragTrap::rangedAttack(Robot &target)
{
...
void	FragTrap::meleeAttack(Robot &target)
{
...
void	FragTrap::vaulthunter_dot_exe(Robot &target)
{
	int	r;
...
void	FragTrap::attackRandom0(FragTrap &attacker, Robot &target)
{
...
void	FragTrap::attackRandom1(FragTrap &attacker, Robot &target)
{
	std::cout << "FR4G-TP " << attacker._name
...
void	FragTrap::attackRandom2(FragTrap &attacker, Robot &target)
{
	std::cout << "FR4G-TP " << attacker._name
...
void	FragTrap::attackRandom3(FragTrap &attacker, Robot &target)
{
	std::cout << "FR4G-TP " << attacker._name
...
void	FragTrap::attackRandom4(FragTrap &attacker, Robot &target)
{
	std::cout << "FR4G-TP " << attacker._name
